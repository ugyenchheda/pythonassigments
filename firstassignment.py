...
def all_note_lists():
    ...
    if global_username not in user_notes or not user_notes[global_username]:
        ...
        button_cancel = tk.Button(option_view, text="Go to Dashboard", width=15, padx=5, height=1, bg=theme_color2, fg=theme_color4, font=("Helvetica", 12, "bold"), justify=CENTER, command=user_authentication)
